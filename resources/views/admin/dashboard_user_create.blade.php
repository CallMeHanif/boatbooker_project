            ...
            <div class="order">
                <form role="form" method="post" action="{{ route('add_user') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" name="email" oninput="validateEmail(this)" /><br>
                        <label>Password : </label><br>
                        <input class="form-control" type="password" name="password" /><br>
                        <label>Role : </label><br>
                        <div class="custom-select" style="width:100%;">
                            <select
                                style="font-size: 16px ; padding: 6px 5px; margin: 8px 0px; width:100%; border-radius: 0.25rem; border: 1px solid #ccc;"
                                name="is_admin" id="" class="form-control">
                        ...
                        <input class="form-control" type="text" name="call_num" oninput="validatePhoneNumber(this)"><br>
